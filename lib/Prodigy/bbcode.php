...
$this->bbcode = array(
    'from' => array(
        ...
        'blocks' => array(
            ...
            '/\s*\[td\]\s*(.*?)\s*\[\/td\]\s*/is',
            '/\[hr\]/i',
            '~\[(?:y|youtube\S*?|video|media\S*?)\]https?://(?:\S+?\.)?youtube\.com/playlist(\?(?:\S+?)?list=(\S+?)(?:\&\S+)?)\[/(?:y|youtube|video|media)\]~i',
            '~\[(?:y|youtube\S*?|video|media\S*?)\]https?://(?:\S+?\.)?youtube\.com/watch(\?(?:\S+?)?v=(\S+?)(?:\&\S+)?)\[/(?:y|youtube|video|media)\]~i',
            '~\[(?:y|youtube\S*?|video|media\S*?)\]https?://youtu.be/(\S+?)(\?[^\s\[]*)?\[/(?:y|youtube|video|media)\]~i',
