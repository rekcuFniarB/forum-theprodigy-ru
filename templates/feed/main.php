...
<style>
  ...
  <?php if(file_exists("./templates/css/{$GLOBALS['skinname']}.css")) include("./templates/css/{$GLOBALS['skinname']}.css"); ?>
</style>
...
<nav class="cats-menu">
  ...
  <?php endforeach; ?>
    <li><a class="quote nav-item<?= $this->cat == 0 ? ' current ' : '' ?>" href="<?= $this->appDir ?>/0/"><?= $this->txt['feed_all_cats'] ?></a></li>
  </ul>
  <?php endif; ?>
  ...
  <?php if($this->displayFilterLnk): ?>
    ...
    <?php if($this->unfiltered): ?>
      <a class="articles-filter-btn" href="../"><?= $this->txt['feed_show_approved'] ?></a>
    <?php else: ?>
      <a class="articles-filter-btn" href="./all/"><?= $this->txt['feed_show_non_approved'] ?></a>
    <?php endif; ?>
  <?php endif; ?>
</nav>
